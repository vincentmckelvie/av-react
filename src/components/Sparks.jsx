...
function Fatline({ curve, width, color, speed }) {
  ...
  return (
    <mesh>
      <meshline.meshLineGeometry attach="geometry" vertices={curve} />
      <meshline.meshLineMaterial ref={material} transparent depthTest={false} lineWidth={width} color={color} dashArray={0.1} dashRatio={0.95} />
    </mesh>
  )
}
